...
refreshed 156-tool Clockify API catalog and the generated 192-operation
...
**Tier 2 (104 tools, 12 groups, on demand):** invoices, expenses, scheduling, time off, approvals, shared reports, user admin, webhooks, custom fields, groups/holidays, project admin, and `probe_lab_api` documented-API escape hatch tools.
