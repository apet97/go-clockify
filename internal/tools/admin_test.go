...
// TestTestWebhookDryRun locks the current API reality: Clockify does not expose
// a webhook test-send endpoint, so the tool returns recovery guidance without
