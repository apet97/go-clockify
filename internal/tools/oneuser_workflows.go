...
func (s *Service) workflowDescriptors() []mcp.ToolDescriptor {
	return []mcp.ToolDescriptor{
		advertiseOutputSchema(workflowDescriptor(0, "workspace", "workspace", []string{"Check identity, workspace, timezone, timer state, and next tools."}, nil,
		...
		advertiseOutputSchema(workflowDescriptor(2, "work_tracking", "work_package", []string{"Create or reuse client, project, task, and tag objects in one call."}, []string{"clockify_clients_create", "clockify_projects_create", "clockify_tasks_create", "clockify_tags_create"},
		...
		advertiseOutputSchema(workflowDescriptor(3, "work_tracking", "entry", []string{"Log finished work with project, task, and tag names or IDs."}, []string{"clockify_entries_create", "clockify_api_request"},
		...
		advertiseOutputSchema(workflowDescriptor(4, "work_tracking", "entry", []string{"Start a running timer with project, task, and tag names or IDs."}, []string{"clockify_entries_timer_start", "clockify_entries_create"},
			toolRW("clockify_start_work", "Start a running work timer using names or IDs.", startWorkSchema()), s.ClockifyStartWork)),
		advertiseOutputSchema(workflowDescriptor(5, "work_tracking", "entry", []string{"Stop the current running timer."}, []string{"clockify_entries_timer_stop"},
			toolRWIdem("clockify_stop_work", "Stop the current running work timer.", stopWorkSchema()), s.ClockifyStopWork)),
		advertiseOutputSchema(workflowDescriptor(6, "work_tracking", "entry", []string{"Stop current work and start another timer in one call."}, []string{"clockify_stop_work", "clockify_start_work", "clockify_entries_timer_switch"},
		...
		advertiseOutputSchema(workflowDescriptor(7, "review", "entry", []string{"Review one day for totals, missing fields, gaps, overlaps, and next actions."}, []string{"clockify_reports_detailed", "clockify_entries_list"},
		...
		advertiseOutputSchema(workflowDescriptor(8, "review", "entry", []string{"Review one week for totals, missing fields, gaps, overlaps, and next actions."}, []string{"clockify_reports_weekly", "clockify_entries_list"},
		...
		advertiseOutputSchema(workflowDescriptor(9, "work_tracking", "entry", []string{"Find and fix one time entry without hand-chaining get/update calls."}, []string{"clockify_entries_get", "clockify_entries_update", oneUserToolFixEntry},
