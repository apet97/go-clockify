...
func TestClientProjectTaskDocSchemaProperties(t *testing.T) {
	...
	requireProps("clockify_list_projects", "strict_name_search", "clients", "contains_client", "client_status", "users", "contains_user", "user_status", "is_template", "hydrated", "access", "expense_limit", "expense_date", "user_groups", "contains_group")
	requireProps("clockify_create_project", "client_id", "cost_rate", "hourly_rate", "estimate", "memberships", "tasks", "budget_estimate", "time_estimate")
	requireProps("clockify_update_project", "client_id", "cost_rate", "hourly_rate", "estimate", "memberships", "tasks", "budget_estimate", "estimate_reset", "time_estimate")
	requireProps("clockify_list_tasks", "name", "strict_name_search", "is_active", "sort_column", "sort_order")
	requireProps("clockify_create_task", "assignee_id", "assignee_ids", "budget_estimate", "contains_assignee", "user_group_ids")
	requireProps("clockify_update_task", "assignee_id", "assignee_ids", "budget_estimate", "contains_assignee", "membership_status", "user_group_ids")
