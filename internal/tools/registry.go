...
func (s *Service) Registry() []mcp.ToolDescriptor {
	return []mcp.ToolDescriptor{
		{Tool: toolRO("clockify_whoami", "Get current user and resolved workspace", map[string]any{"type": "object"}), ReadOnlyHint: true, Handler: func(ctx context.Context, _ map[string]any) (any, error) { return s.WhoAmI(ctx) }},
		{Tool: toolRO("clockify_list_workspaces", "List available Clockify workspaces", map[string]any{"type": "object"}), ReadOnlyHint: true, Handler: func(ctx context.Context, _ map[string]any) (any, error) { return s.ListWorkspaces(ctx) }},
		{Tool: toolRO("clockify_get_workspace", "Get the resolved workspace", map[string]any{"type": "object"}), ReadOnlyHint: true, Handler: func(ctx context.Context, _ map[string]any) (any, error) { return s.GetWorkspace(ctx) }},
		{Tool: toolRO("clockify_list_users", "List users in the resolved workspace", map[string]any{"type": "object"}), ReadOnlyHint: true, Handler: func(ctx context.Context, _ map[string]any) (any, error) { return s.ListUsers(ctx) }},
		{Tool: toolRO("clockify_current_user", "Get the current Clockify user", map[string]any{"type": "object"}), ReadOnlyHint: true, Handler: func(ctx context.Context, _ map[string]any) (any, error) { return s.CurrentUser(ctx) }},
		{Tool: toolRO("clockify_list_projects", "List projects in the resolved workspace", map[string]any{"type": "object"}), ReadOnlyHint: true, Handler: func(ctx context.Context, _ map[string]any) (any, error) { return s.ListProjects(ctx) }},
		{Tool: toolRO("clockify_get_project", "Get a project by ID or exact name", requiredSchema("project")), ReadOnlyHint: true, Handler: func(ctx context.Context, args map[string]any) (any, error) {
			return s.GetProject(ctx, stringArg(args, "project"))
		}},
		{Tool: toolRO("clockify_list_clients", "List clients in the resolved workspace", map[string]any{"type": "object"}), ReadOnlyHint: true, Handler: func(ctx context.Context, _ map[string]any) (any, error) { return s.ListClients(ctx) }},
		{Tool: toolRO("clockify_list_tags", "List tags in the resolved workspace", map[string]any{"type": "object"}), ReadOnlyHint: true, Handler: func(ctx context.Context, _ map[string]any) (any, error) { return s.ListTags(ctx) }},
		{Tool: toolRO("clockify_list_tasks", "List tasks for a project", requiredSchema("project")), ReadOnlyHint: true, Handler: func(ctx context.Context, args map[string]any) (any, error) {
			return s.ListTasks(ctx, stringArg(args, "project"))
		}},
		...
		{Tool: toolRO("clockify_get_entry", "Get a single time entry by ID", requiredSchema("entry_id")), ReadOnlyHint: true, Handler: func(ctx context.Context, args map[string]any) (any, error) {
		...
		{Tool: toolRW("clockify_stop_timer", "Stop the current running timer", map[string]any{"type": "object", "properties": map[string]any{"dry_run": map[string]any{"type": "boolean"}}}), ReadOnlyHint: false, Handler: func(ctx context.Context, args map[string]any) (any, error) { return s.StopTimer(ctx, args) }},
		...
		{Tool: toolRW("clockify_update_entry", "Update an existing time entry (fetch-then-update merge)", map[string]any{"type": "object", "required": []string{"entry_id"}, "properties": map[string]any{
		...
		{Tool: toolRW("clockify_find_and_update_entry", "Find one current-user entry by exact ID or safe filters, then update selected fields. Fails closed on ambiguous matches.", map[string]any{"type": "object", "properties": map[string]any{"entry_id": map[string]any{"type": "string"}, "description_contains": map[string]any{"type": "string"}, "exact_description": map[string]any{"type": "string"}, "start_after": map[string]any{"type": "string", "description": "RFC3339 timestamp"}, "start_before": map[string]any{"type": "string", "description": "RFC3339 timestamp"}, "new_description": map[string]any{"type": "string"}, "project_id": map[string]any{"type": "string"}, "project": map[string]any{"type": "string"}, "start": map[string]any{"type": "string", "description": "RFC3339 timestamp"}, "end": map[string]any{"type": "string", "description": "RFC3339 timestamp"}, "billable": map[string]any{"type": "boolean"}, "dry_run": map[string]any{"type": "boolean"}}}), ReadOnlyHint: false, Handler: func(ctx context.Context, args map[string]any) (any, error) {
		...
		// --- Wave 2 additions ---
		{Tool: toolRO("clockify_timer_status", "Check if a timer is currently running and show elapsed time", map[string]any{"type": "object"}), ReadOnlyHint: true, Handler: func(ctx context.Context, _ map[string]any) (any, error) {
		...
		{Tool: toolRO("clockify_policy_info", "Display effective policy configuration", map[string]any{"type": "object"}), ReadOnlyHint: true, Handler: func(ctx context.Context, _ map[string]any) (any, error) {
