...
func TestOneUserNativeDiscoveryToolsAreNotAliasWrappers(t *testing.T) {
	...
	wantNative := map[string]bool{
		...
		"clockify_webhooks_test_guidance":         true,
...
func TestOneUserDomainCRUDOutputSchemasAreTyped(t *testing.T) {
	...
	wantFields := map[string][]string{
		...
		"clockify_invoices_send_guidance":         {"supported", "performed", "hint"},
		"clockify_invoices_mark_paid":             {"id"},
		"clockify_invoices_items_list":            {"invoiceItemId"},
		"clockify_invoices_items_add":             {"id"},
		"clockify_invoices_items_update_guidance": {"supported", "performed", "hint"},
		"clockify_invoices_items_delete":          {"invoiceId"},
		"clockify_invoices_export":                {"content", "contentType", "filename", "bytes", "bodyEncoding", "base64Bytes", "truncated"},
		...
		"clockify_webhooks_test_guidance":         {"supported", "performed", "hint"},
...
func TestEveryToolHasTitle(t *testing.T) {
	for _, descriptor := range mustRegistry(t, &Service{}) {
...
func TestOneUserCoverageLedgerLiveReadyRowsHaveNamedGatedEvidence(t *testing.T) {
	...
	requiredGates := coverageEvidenceRequiredGates()
	knownGates := knownCoverageGateSet()
...
func coverageEvidenceRequiredGates() map[string][]string {
...
func knownCoverageGateSet() map[string]bool {
	return setOf(
	...
	for _, descriptor := range mustRegistry(t, svc) {
		...
		t.Run(descriptor.Tool.Name, func(t *testing.T) {
			if wantRecovery, ok := map[string]string{
				"clockify_invoices_send_guidance":         "clockify_invoices_get",
				"clockify_invoices_mark_paid":             "clockify_invoices_payments_create",
				"clockify_webhooks_test_guidance":         "clockify_webhooks_get",
				"clockify_invoices_items_update_guidance": "clockify_invoices_items_delete",
