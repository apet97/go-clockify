...
// TestNormalizeEndpoint_IDShapesCollapsed confirms the three ID shapes
// (24-hex BSON, 32-hex UUID-without-hyphens, 36-char canonical UUID) all
// collapse to :id. These are the shapes Clockify's API actually returns.
...
// TestNormalizeEndpoint_NonIDShapesPreserved locks the length-bounded
// matcher (24/32/36): a 16-char hex token, a 40-char SHA, or a slug stays
// in the path verbatim rather than collapsing to :id.
