...
func TestEnvSpec_CoversEveryGetenv(t *testing.T) {
	...
	outOfConfigGo := map[string]bool{
		...
		"CLOCKIFY_CONFIRMATION_REPLAY_PROTECTION": true, // internal/confirmation (loader)
		...
		"CLOCKIFY_PER_TENANT_CONCURRENCY":         true, // internal/ratelimit
		"CLOCKIFY_PER_TENANT_RATE_LIMIT":          true, // internal/ratelimit
