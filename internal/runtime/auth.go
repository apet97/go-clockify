...
func buildAuthnConfig(cfg config.Config) authn.Config {
	return authn.Config{
		...
		OIDCJWKSAllowPrivate:      cfg.OIDCJWKSAllowPrivate,
		OIDCResourceURI:           cfg.OIDCResourceURI,
		OIDCVerifyCacheTTL:        cfg.OIDCVerifyCacheTTL,
		OIDCJWKSCacheTTL:          cfg.OIDCJWKSCacheTTL,
		OIDCStrict:                cfg.OIDCStrict,
		OIDCRequireKID:            cfg.OIDCRequireKID,
		...
		RequireForwardTenantClaim: cfg.RequireForwardTenantClaim,
